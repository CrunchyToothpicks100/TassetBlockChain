...
7. Save and close test editors
8. `dotnet run`

## How is this different from 2BlockChain?

2BlockChain builds a blockchain from a file using a set number of "lines" for each block. TassetBlockChain is not _really_ a blockchain. It takes one block and mines it over and over, writing all successful output until the user terminates the terminal. The lack of termination is intentional. You might get really lucky and get a hash with more zeros than your chosen difficulty.
